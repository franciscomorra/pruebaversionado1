...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__Afiliados__Falta__5B052800]') AND type = 'D')
BEGIN
ALTER TABLE [SHARPS].[Afiliados] DROP CONSTRAINT [DF__Afiliados__Falta__5B052800]
END
...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__Profesion__Falta__73D0D5CA]') AND type = 'D')
BEGIN
ALTER TABLE [SHARPS].[Profesionales] DROP CONSTRAINT [DF__Profesion__Falta__73D0D5CA]
END
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[SHARPS].[FK_Recetas_Consultas]') AND parent_object_id = OBJECT_ID(N'[SHARPS].[Recetas]'))
ALTER TABLE [SHARPS].[Recetas] DROP CONSTRAINT [FK_Recetas_Consultas]
GO
...
/****** Object:  Table [SHARPS].[Afiliados]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Agendas]    Script Date: 11/26/2013 23:49:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[SHARPS].[Agendas]') AND type in (N'U'))
DROP TABLE [SHARPS].[Agendas]
GO

/****** Object:  Table [SHARPS].[Bonos_Consulta]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Bonos_Farmacia]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Cambios_Afiliado]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Compras]    Script Date: 11/26/2013 23:49:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[SHARPS].[Compras]') AND type in (N'U'))
DROP TABLE [SHARPS].[Compras]
GO

/****** Object:  Table [SHARPS].[Consultas]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Detalles_Persona]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Especialidades]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Estados_Civiles]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Estados_Turno]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Funcionalidades]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Medicamentos]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Perfiles]    Script Date: 11/26/2013 23:49:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[SHARPS].[Perfiles]') AND type in (N'U'))
DROP TABLE [SHARPS].[Perfiles]
GO

/****** Object:  Table [SHARPS].[Perfiles_Funcionalidades]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Planes_Medicos]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Profesionales]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Profesionales_Especialidades]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Recetas]    Script Date: 11/26/2013 23:49:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[SHARPS].[Recetas]') AND type in (N'U'))
DROP TABLE [SHARPS].[Recetas]
GO

/****** Object:  Table [SHARPS].[Recetas_Medicamentos]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Roles]    Script Date: 11/26/2013 23:49:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[SHARPS].[Roles]') AND type in (N'U'))
DROP TABLE [SHARPS].[Roles]
GO

/****** Object:  Table [SHARPS].[Roles_Funcionalidades]    Script Date: 11/26/2013 23:49:56 ******/
...
/****** Object:  Table [SHARPS].[Tipos_Especialidades]    Script Date: 11/26/2013 23:49:56 ******/
