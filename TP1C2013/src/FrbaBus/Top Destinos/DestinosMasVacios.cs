...
{
    public partial class DestinosMasVacios : Form
    {
        public DestinosMasVacios()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@" ACTITUD_GDD.TOP5DESTINOSMASVACIOS '" + Semestre.calcularFechaSemestre(int.Parse(comboBox1.Text), int.Parse(comboBox2.Text)).ToShortDateString() + "'", con);
