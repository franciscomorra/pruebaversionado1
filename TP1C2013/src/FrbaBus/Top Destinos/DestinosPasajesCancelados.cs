...
{
    public partial class DestinosPasajesCancelados : Form
    {
        public DestinosPasajesCancelados()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"ACTITUD_GDD.TOP5PASAJESCANCELADOS '" + Semestre.calcularFechaSemestre(int.Parse(comboBox1.Text), int.Parse(comboBox2.Text)).ToShortDateString() + @"'", con);
